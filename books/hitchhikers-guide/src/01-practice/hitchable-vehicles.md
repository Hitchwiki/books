...
With persistence and a little bit of luck, almost any type of vehicle can be hitchhiked. They, however, vary in difficulty, comfort, and availability.
...
See [Hitchhiking a truck](Hitchhiking_a_truck "Hitchhiking a truck"){.wikilink}

## Busses, Minibusses, Commercial Vans, Marshrutkas (CIS) {#busses_minibusses_commercial_vans_marshrutkas_cis}
...
See [Hitchhiking a bus](Hitchhiking_a_bus "Hitchhiking a bus"){.wikilink}

## Freight Train {#freight_train}
...
See [Train hopping](Train_hopping "Train hopping"){.wikilink}

## Passenger Train {#passenger_train}

Similar to bus+, but with more possibilities to bend the rules for creative people.

See [Train](Train "Train"){.wikilink}

## Boats

See [Hitchhiking a boat](Hitchhiking_a_boat "Hitchhiking a boat"){.wikilink}

## Planes

See [Hitchhiking a plane](Hitchhiking_a_plane "Hitchhiking a plane"){.wikilink}

## Air-Based Transports {#air_based_transports}
...
Can it be ridden? It is big and strong, sure, but not generally known to drive people Let us know.
