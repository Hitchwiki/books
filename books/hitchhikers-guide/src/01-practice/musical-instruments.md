...
**Musical instruments** can be fun to [carry along](Things_to_carry "carry along"){.wikilink} when [hitchhiking](hitchhiking "hitchhiking"){.wikilink} and if you\'re [busking](busking "busking"){.wikilink} it\'s quite good to have at least one instrument.
