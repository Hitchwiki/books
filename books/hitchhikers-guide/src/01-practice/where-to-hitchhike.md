...
A good **hitchhiking spot** makes hitchhiking safer and easier. Finding a good spot might be tricky, and sometimes knowing the area is an advantage. If you know your route, you might check the best places on this wiki, [Hitchwiki Maps](https://maps.hitchwiki.org) or from the [internet](multimedia "internet"){.wikilink}, including [Google Maps](http://maps.google.com), before heading to the road.

There are some generic hitchhiking places, like [petrol stations](petrol_stations "petrol stations"){.wikilink}, bus stops etc. This page attempts to provide an understanding about where you should hitchhike.

: *See also the article on [how to pick up hitchhikers](picking_up_hitchhikers "how to pick up hitchhikers"){.wikilink}.*

## What the data says {#what_the_data_says}

An analysis of 32,475 ride comments on [Hitchwiki Maps](https://maps.hitchwiki.org) found that gas stations (2,425 mentions) are by far the most frequently referenced landmark, followed by bus stops (1,732) and roundabouts (1,083). Nearly half of all reported waits (47%) were under 15 minutes, with a median of 20 minutes. Highly-rated spots are most often described as \"easy\" with short waits, while poorly-rated spots involve waits measured in hours.

The data confirms what experienced hitchhikers already know: gas stations on motorways are the most reliable type of spot. The sections below describe each type in detail.
...
## [Petrol stations](Petrol_station_hitchhiking "Petrol stations"){.wikilink} {#petrol_stations}

![A monk from the Holy Hitch-hiking Order near Arles, [France](France "France"){.wikilink}.](Hitchmonk.jpg "A monk from the Holy Hitch-hiking Order near Arles, France."){width="400"} Petrol stations are good places to ask for a ride, especially while hitchhiking along a motorway.
...
- Possibly warm.
- Sometimes a convenient (but often expensive) source of (usually bad) [food](food "food"){.wikilink}, drinks, [maps](maps "maps"){.wikilink} and toilets.
...
## [On ramps](On-ramp "On ramps"){.wikilink} {#on_ramps}

![Workshop during the [888](888 "888"){.wikilink}-event on where to hitchhike from in [Paris](Paris "Paris"){.wikilink}](Spot-sharing.jpg "Workshop during the 888-event on where to hitchhike from in Paris"){width="400"}
...
## Toll Booths / [Péages](Péage "Péage"){.wikilink} {#toll_booths_péages}
...
- On roads with heavy traffic they are very huge and only the cars from the first lanes can see you (for example on the motorways leaving [Paris](Paris "Paris"){.wikilink})
...
- It is against the policy for trucking companies in certain countries to have riders because of [insurance](insurance "insurance"){.wikilink} reasons

## Outside of town {#outside_of_town}
...
## Anywhere cars can pull over safely {#anywhere_cars_can_pull_over_safely}

- huge parking spaces

Nine times out of ten you can get a ride anywhere there is a parking lot;(i.e. park and ride).

## [Traffic lights](Traffic_light_hitchhiking "Traffic lights"){.wikilink} {#traffic_lights}
...
Even national roads (non-motorway) often provide good space along the main flow of traffic, as there are often emergency lanes or so called [Mehrzweckstreifen](Mehrzweckstreifen "Mehrzweckstreifen"){.wikilink}.

Finally, hitchhiking on emergency lanes of motorways can be an option in case of traffic jams. In such situation using a [cardboard sign](signs "cardboard sign"){.wikilink} is usually highly effective. It is necessary though to take maximum safety precautions (we suppose you are smart enough to take these precautions), and you should know that hitchhiking on motorways is basically forbidden in most Western countries.

## Asking locals about good hitchhiking spots {#asking_locals_about_good_hitchhiking_spots}
...
## Leaving the vehicle {#leaving_the_vehicle}
