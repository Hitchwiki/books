...
There are lots of different theories and practices around [hitchhiking](hitchhiking "hitchhiking"){.wikilink} **etiquette** and courtesy for your driver. Also, there is some general rules about treating other hitchhikers on the road.

## Etiquette on the road {#etiquette_on_the_road}

**Be courteous:** Hollaring at drivers, standing in the road, or just generally being a nuisance can be dangerous and will not only deter drivers from picking you up, it may affect that driver\'s perception toward hitchhikers in the future.

**Keep your cool:** It\'s easy to get frustrated when thumbing, especially when there are plenty of passing drivers going your direction. It is important that you keep rude gestures in your head and objects away from the car. There have been stories of hitchhikers purposefully putting objects in the road to intercept drivers that pass by. For all of us, don\'t do it.

## Etiquette with drivers {#etiquette_with_drivers}
...
### Tricky conversations {#tricky_conversations}
...
## Etiquette with hitchhikers {#etiquette_with_hitchhikers}
