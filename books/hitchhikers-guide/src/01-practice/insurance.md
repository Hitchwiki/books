...
## Situation in [Spain](Spain "Spain"){.wikilink} {#situation_in_spain}
...
## Situation in the [United Kingdom](United_Kingdom "United Kingdom"){.wikilink} {#situation_in_the_united_kingdom}
...
`<span class="hw-exp-title">`{=html}3 times useful`</span>`{=html} `<span class="hw-exp-author">`{=html}Anonymous`</span>`{=html} `<span class="hw-exp-date">`{=html}December 2010`</span>`{=html}
...
Source: [Insurance](https://hitchwiki.org/en/Insurance)
