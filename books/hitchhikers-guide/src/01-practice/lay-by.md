...
The term **lay-by** is used in the [United Kingdom](United_Kingdom "United Kingdom"){.wikilink} and [Ireland](Ireland "Ireland"){.wikilink} to describe a roadside parking or rest area for drivers (equivalent terms in the [United States](United_States_of_America "United States"){.wikilink} are \"**turnout**\" or \"**pullout**\"). Lay-bys can be used for [hitchhiking](hitchhiking "hitchhiking"){.wikilink} purposes, although due to a very few cars actually driving in there, do not expect very fast hitchhiking.
