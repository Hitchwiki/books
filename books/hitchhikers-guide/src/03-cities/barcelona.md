...
You can also ask the driver to leave you at the junction by the university (*Universitat Autonoma de Barcelona*). There is a [roundabout](roundabout "roundabout"){.wikilink} right by the motorway ramp. The only challenge is that your driver has to be going from the junction of *Barbera de valles* on the right site of the motorway as it gets split - otherwise you leave the car at *Castellbisbal* [service station](rest_area "service station"){.wikilink}.

### [Ferry](Ferry "Ferry"){.wikilink} to [Mallorca](Mallorca "Mallorca"){.wikilink}, [Menorca](Menorca "Menorca"){.wikilink}, [Ibiza](Ibiza "Ibiza"){.wikilink} {#ferry_to_mallorca_menorca_ibiza}

Pls add info

## Barcelona Public Transport {#barcelona_public_transport}
...
## Blackriding long distance trains {#blackriding_long_distance_trains}
...
## Staying in Barcelona {#staying_in_barcelona}

### Free food and shower {#free_food_and_shower}
...
### Hospitality exchange {#hospitality_exchange}

[Hospitality exchange networks](Accommodation#Hospitality_exchange_networks "Hospitality exchange networks"){.wikilink} have many members in Barcelona, however, you have to plan your stay well ahead since it is quite a popular destination.

### Sleeping in public areas {#sleeping_in_public_areas}
...
### Sleeping in empty or occupied buildings and rooftops {#sleeping_in_empty_or_occupied_buildings_and_rooftops}
