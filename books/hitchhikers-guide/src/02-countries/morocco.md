...
Moroccan car license plates tell where a car is from. Find a complete list [here](http://licenseplatemania.com/landenpaginas/marokko.htm).
...
### Under the Stars {#under_the_stars}
...
### Getting invited into people\'s homes {#getting_invited_into_peoples_homes}
...
## Religion and Politics {#religion_and_politics}
...
## Hitchhiking Events {#hitchhiking_events}

The Hitch is LCD's largest fundraising event and hitching the 1600km or 1000 miles is a true feat of achievement. All the Hitchers have now safely returned to the UK, but the money is still rolling in.

## Personal Experiences {#personal_experiences}

<div class="hw-experience">

`<span class="hw-exp-author">`{=html}[Cigarettesbum](User:_Cigarettesbum "Cigarettesbum"){.wikilink}`</span>`{=html} `<span class="hw-exp-date">`{=html}5 March 2024`</span>`{=html}
