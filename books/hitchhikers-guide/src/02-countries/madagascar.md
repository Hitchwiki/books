...
**Madagascar** is a big island nation that is part of [Eastern Africa](Eastern_Africa "Eastern Africa"){.wikilink}.
...
`<span class="hw-exp-author">`{=html}[Iris from Mind of a Hitchhiker](User:MOAH "Iris from Mind of a Hitchhiker"){.wikilink} and Jonas`</span>`{=html} `<span class="hw-exp-date">`{=html}2022`</span>`{=html}

<div class="hw-exp-text">

In late 2022, [Iris from Mind of a Hitchhiker](User:MOAH "Iris from Mind of a Hitchhiker"){.wikilink} and Jonas [caught a very short ride in Ranohira near Isalo National Park](https://mindofahitchhiker.com/ranohira-our-first-time-hitchhiking-in-madagascar/). In general, I found that distances are long, roads are shit, gas is expensive, vehicles are too full, and there are too few people with private cars to make hitchhiking long distances all over the country reliable enough as a method of transportation in Madagascar. Especially as a foreigner. A (basic) command of Malagasy or French is essential. Cyclone season is also a gamble since if you pass over a road it might not exist anymore by the time you go back.
...
Source: [Madagascar](https://hitchwiki.org/en/Madagascar)  
