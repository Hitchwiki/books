...
**Andorra** is a very small country in the Pyrenees, surrounded by [France](France "France"){.wikilink} and [Spain](Spain "Spain"){.wikilink}.
...
Hitchhiking is not an offence in Andorra and there is no road you are banned from: the [*Llei 12/2021, del 13 de maig, del Codi de la circulació*](https://portaljuridicandorra.ad/L2021012_0) defines an *autopista* in article 3(6) but the country has none, so the pedestrian rules apply on every road in the principality, the CG-1 and CG-2 included. Article 49(1) puts you on the pavement where there is one and otherwise as close as possible to the edge of the *calçada* --- and on a road without pavements it puts you on the \*\*left-hand\*\* margin, facing the traffic, which is the side to wait on unless safety plainly argues otherwise. Article 50(1) is the one with teeth for hitchhikers: outside built-up areas, between sunset and sunrise or in poor conditions, anyone on the carriageway or the *voral* must wear a homologated reflective or luminous item visible at 150 m. Nothing in the Code forbids asking a driver for a lift or a driver from stopping to give one, so the practical limits are the mountain roads themselves --- few laybys, tunnels where stopping is banned, and a border post at each end of the country.

![[Sigurdas](User:Sigurdas "Sigurdas"){.wikilink} hitch-hiking on the border Andorra/France.](2002_hitch_hiking_in_Andorra.jpg "Sigurdas hitch-hiking on the border Andorra/France."){width="300"}

## Hitchhiking in {#hitchhiking_in}

When using the [A61](A61_(France) "A61"){.wikilink} in France it\'s better to hitch a ride to the Péage gate\'s just before [Toulouse](Toulouse "Toulouse"){.wikilink}, as there seems to be little trafic from [Carcassonne](Carcassonne "Carcassonne"){.wikilink} to Andorra.

## Hitchhiking out {#hitchhiking_out}

There is only one main road in Andorra. Depending on which direction you can go to either France (North) or Spain (South). [‎GrooteR](User:‎GrooteR "‎GrooteR"){.wikilink} found the locals quite helpful for hitchhikers when thumbing, but the cars waited for (long distance towards France) didn\'t stop.
