...
The **Kingdom of Bhutan** is an isolated country in [Southern Asia](Southern_Asia "Southern Asia"){.wikilink}. In the North it is bordered by the huge Himalaya mountains with a not exactly clear border to the region of [Tibet](Tibet "Tibet"){.wikilink}, [China](China "China"){.wikilink}. In the South it borders [India](India "India"){.wikilink}.
...
![[PhysicsHipster](User:PhysicsHipster "PhysicsHipster"){.wikilink} and Laura hitching in Bhutan](BhutanHitching.jpg "PhysicsHipster and Laura hitching in Bhutan"){width="300"}
