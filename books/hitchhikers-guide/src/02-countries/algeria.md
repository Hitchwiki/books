...
The border to [Morocco](Morocco "Morocco"){.wikilink} is closed. The only open borders actually are with Tunisia, there is some fake news about Mauritania borders but nothing sure, for more informations contact local people in Tindouf.

## Money, internet and accommodation {#money_internet_and_accommodation}
