...
Australia is one of the few countries whose road rules name hitchhiking as an offence in terms. The Australian Road Rules are a model law that each state and territory enacts as its own, so the numbering and the fine differ locally, but the substance is the same: under rule 236(4)(b) of Victoria\'s [Road Safety Road Rules 2017](https://content.legislation.vic.gov.au/sites/default/files/2023-04/17-41sra020-authorised.pdf), \"a pedestrian must not stand on, or move onto, a road to \... hitchhike\", for a penalty of 2 penalty units. What makes that bite harder than it reads is rule 236(5), which provides that *road* here \"includes any shoulder of the road\" --- so unlike in the [United States](United_States_of_America "United States"){.wikilink} the shoulder is not the safe harbour, it is where the offence is committed, and only a *road related area* beyond the shoulder falls outside the rule. Freeways add a second layer: rule 229 makes it an offence carrying 5 penalty units for a pedestrian to go past a road access sign, which is the sign normally posted at a freeway entrance. Because each jurisdiction enacts its own version, check your own state\'s rule 236 rather than relying on this one --- the wording is not uniform across the country, and in practice enforcement of it is patchy.
...
While hitchhiking may be legal in many areas, safety should be the utmost priority. Regardless of the state, travelers are advised to:

`   Choose safe spots for hitchhiking, avoiding busy highways and dangerous areas.`\
`   Use common sense and intuition about the vehicles or drivers that stop.`\
`   Travel with a buddy when possible, as there is safety in numbers.`\
`   Stay visible and dress to attract attention, preferably with signs indicating your destination.`

### Particular to Western Australia {#particular_to_western_australia}
...
In conclusion: in WA, it\'s illegal to stand on the shoulder of the highway; however you may hitchhike from a footpath or off the shoulder. A law enforcement officer might not be aware of this, though. The source is to be found in [this website](http://www.austlii.edu.au/cgi-bin/sinodisp/au/legis/wa/consol_reg/rtc2000113/s259.html?query=hitch%20hike).

### Practical Situation {#practical_situation}
...
Another tip that makes a bit more sense than for [Europe](Europe "Europe"){.wikilink} for example, is to be very careful about not annoying your host. You could be thrown out of the vehicle by the irate driver 200km from the nearest town.

## The Outback {#the_outback}
...
### What to be careful with in the Outback {#what_to_be_careful_with_in_the_outback}
...
## Hitchhiking with "truckies" {#hitchhiking_with_truckies}
...
See [Nomadwiki](http://nomadwiki.org/en/Australia) as it is more relevant for this website.

## Personal experience {#personal_experience_1}

<div class="hw-experience">

`<span class="hw-exp-author">`{=html}Author unknown`</span>`{=html}

<div class="hw-exp-text">

I have hitched the entire coastline of Australia, and although there are sometimes long waits between rides, I have met some of the most generous and welcoming people. Make sure you get to the edge of the towns, just where the highways start or turn from a 70 into a 100 km/h zone, or similar.

</div>
</div>
<div class="hw-experience">

`<span class="hw-exp-author">`{=html}Jools`</span>`{=html} `<span class="hw-exp-date">`{=html}2011`</span>`{=html}
...
`<span class="hw-exp-author">`{=html}Hitchhikernick`</span>`{=html} `<span class="hw-exp-date">`{=html}2015-16, 2019 June-Aug, 2023 July-Sept`</span>`{=html}

<div class="hw-exp-text">

I have visited nearly every nook and cranny of Australia over the course of several visits; in 2015-16 WHV, 2019 June-Aug and 2023 July-Sept. Pick up times have varied from seconds to 3 days. The longest wait was in Kununurra heading towards Catherine where I waited 3 days with my skis and had to follow the shade of the speed sign at edge of town in 35 centigrade heat, thankfully there were hospitable locals who helped me out until i finally got a lift. I managed to reach Cape York and climb Uluru (Ayres Rock), with my skis, in my 2019 visit 😁
...
- [Bruce Highway](Bruce_Highway "Bruce Highway"){.wikilink}
- [Hume Highway](Hume_Highway "Hume Highway"){.wikilink}, from Sydney to Melbourne
- [New England Highway](New_England_Highway "New England Highway"){.wikilink}, from Sydney to Brisbane
- [Pacific Motorway](Pacific_Highway_(Australia) "Pacific Motorway"){.wikilink}, from Sydney to Brisbane
- [Princes Highway](Princes_Highway "Princes Highway"){.wikilink}, from Sydney to Melbourne
- [Stuart Highway](Stuart_Highway "Stuart Highway"){.wikilink}, from Darwin to Adelaide
