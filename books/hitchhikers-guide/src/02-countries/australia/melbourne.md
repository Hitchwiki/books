...
\
**Melbourne** is the second largest city in [Australia](Australia "Australia"){.wikilink}.
...
Between Bairnsdale and Eden, there is a long stretch with no bigger towns in between. Be prepared for longer waiting and possibly need to sleep outside. Not the fastest way in order to get to Sydney, but definitely doable, and loads of interesting spots at the coast along the way. For a more direct connection to [Sydney](Sydney "Sydney"){.wikilink}, the [Hume Highway](Hume_Highway "Hume Highway"){.wikilink} is better recommended rather than the scenic coast road.

#### The original option {#the_original_option}

*30 minutes+ of walking*

To get to the *Great Ocean Road* take a train to [Geelong](Geelong "Geelong"){.wikilink} (ca. 8A\$ as of January 2013). Go right out of the station and onto the main highway. There\'s no awesome hitchhiking spots anywhere near, but cars can be stopped in different spots along the road. If you walk about 2 km (or more\...) down the road, you will find a really good spot just before the bridge. From anywhere else between Torquay and Apollo Bay, rides are extremely easy to pick up.

#### The easy option {#the_easy_option}
...
#### The suburban option {#the_suburban_option}
...
## Food, public transport, sleep {#food_public_transport_sleep}

### Food

[Food Not Bombs Melbourne](https://www.facebook.com/groups/foodnotbombsmelbourne/) cooks and serves vegan dinner on Mondays and Tuesdays in the city, and Wednesdays in Coburg.
...
Just make sure the station you want to get off at is a station you can travel to with myki. The solid purple line on this [V/Line Map](https://static.ptv.vic.gov.au/PDFs/Maps/Network-maps/1485494075/PTV_Regional-Train-Coach_Network_Map_2017.pdf) is where you can go with a myki card.
