...
An aimless hitchhiker wrote about her experiences of hitching in Mongolia [here](https://anaimlesshitchhiker.com/2014/09/16/brighton-to-beijing-overland-part-4-the-green-grass-of-smiley-mongolia/#more-1593).
...
There are just a couple hundred km of paved road from [Ulaanbaatar](Ulan_Bator "Ulaanbaatar"){.wikilink} in every geographical directions (exactly one per direction) and that\'s it. No roads, no signs. The trunk roads out of Ulaanbaatar are paved and reasonably trafficked. Be careful if you walk out of the cities, along the *roads* so you don\'t get lost, and take water with you. Confusingly, names of cities equal names of states, so make sure city and state match.
...
Source and detailed information for this section: [here](http://takemeeast.blogspot.com/2014/01/the-failed-ride.html) and [here](http://takemeeast.blogspot.com/2013/12/mongolian-countryside.html)
...
Mongolian law does not mention hitchhiking, and unusually for the region the [*Замын хөдөлгөөний дүрэм*](https://legalinfo.mn/mn/detail?lawId=208663) contains no motorway chapter at all --- its nineteen chapters run from drivers\' duties to residential areas without ever reserving a class of road for vehicles, so there is no road a pedestrian is banned from outright. What it does regulate is where you walk: rule 5.1 puts you on the footway, failing that on the *хөвөө* (the verge), and failing both on the edge of the carriageway in single file, facing the oncoming traffic. Rule 5.12(b) forbids standing or lingering on the carriageway for any reason other than your own safety, so wait on the verge and step out only once a driver has actually stopped. Rule 5.2 asks you to wear light-coloured or reflective clothing on an unlit road after dark, which on the long dark stretches between *aimag* centres is worth doing whatever the law says. The real constraint on hitchhiking in Mongolia is the road network and the distances, not the traffic code.
