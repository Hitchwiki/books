...
**Dakar** is the capital of [Senegal](Senegal "Senegal"){.wikilink}.

Although the city can seem quite chaotic at times, as most big cities do, Dakar actually has a very well-connected bus network. There are several different bus companies, the major ones seem to be the public bus company \"Dakar Dem Dikk\" and the smaller \"Tata\" buses. There is even a [website/app](https://talibi.net/), which allows you to calculate the best connection to your destination.
...
Source: [Dakar](https://hitchwiki.org/en/Dakar)
