...
**Mali** is a landlocked country in [West Africa](Western_Africa "West Africa"){.wikilink}. It is one of the poorest countries in the world. French will be very useful, but [Bambara](Africa_phrasebook#Bambara "Bambara"){.wikilink} is the most spoken language. It\'s very common to mix the two though, but starting with some words in Bambara is highly appreciated.

## Hitchhiking

Inside the capital [Bamako](Bamako "Bamako"){.wikilink} hitchhiking is fairly accepted -- if you look like you have enough money (i.e. white skin) -- and it\'s a reasonable alternative if you can\'t find a taxi [at night](hitchhiking_at_night "at night"){.wikilink}.

Apparently it\'s also possible to get rides with NGO 4WDs at the police check stations.

Mali\'s borders to [Cote d\'Ivoire](Côte_d'Ivoire "Cote d'Ivoire"){.wikilink} in the south and [Algeria](Algeria "Algeria"){.wikilink} in the north are probably a bad idea.
