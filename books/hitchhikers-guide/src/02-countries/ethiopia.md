...
According to the Lonely Planet, the border with [Djibouti](Djibouti "Djibouti"){.wikilink} through [Galafi](Galafi "Galafi"){.wikilink} is accessible only by hitching for its last length with the load of truckers doing the road between [Djibouti](Djibouti_City "Djibouti"){.wikilink} Harbour and [Awash](Awash "Awash"){.wikilink} where a payment of about 150-200Birr (from [Logiya](Logiya "Logiya"){.wikilink}) can be expected.
...
- [Eritrea](Eritrea "Eritrea"){.wikilink}: Border crossing is currently closed since the 1998 war
- [Djibouti](Djibouti "Djibouti"){.wikilink}: via [Logiya](Logiya "Logiya"){.wikilink} and [Galafi](Galafi "Galafi"){.wikilink}

**or** via [Dire Dawa](Dire_Dawa "Dire Dawa"){.wikilink} and [Gelille](Gelille "Gelille"){.wikilink}

- [Somalia](Somalia "Somalia"){.wikilink}/[Somaliland](Somaliland "Somaliland"){.wikilink}: via [Jijiga](Jijiga "Jijiga"){.wikilink} *(to [Somaliland](Somaliland "Somaliland"){.wikilink})*
- [Kenya](Kenya "Kenya"){.wikilink}: via [Moyale](Moyale "Moyale"){.wikilink}
- [Sudan](Sudan "Sudan"){.wikilink}: via [Metemat](Metemat "Metemat"){.wikilink}, note that visa is required in advance which takes up to one month to obtain.
- [South Sudan](South_Sudan "South Sudan"){.wikilink}

## Caution

- Beware of Landmines at the border regions to Somalia, Sudan, Eritrea and Kenya!
- Some Regions are simply closed for Foreigner, either due to the risk of attack, local tension or banditry. These usually includes the Ethiopian Somali Region *(Werder)* and the border with [Eritrea](Eritrea "Eritrea"){.wikilink}. Other region such as the southwestern border with Sudan and Kenya as well as the Afar region can be volatile, so inquire before you go.
...
`<span class="hw-exp-author">`{=html}[Gerben](User:gerbennap "Gerben"){.wikilink}`</span>`{=html} `<span class="hw-exp-date">`{=html}Summer of 2010`</span>`{=html}

<div class="hw-exp-text">

In the summer of 2010, [Gerben](User:gerbennap "Gerben"){.wikilink} hitchhiked through [Ethiopia](Ethiopia "Ethiopia"){.wikilink}, from the [Sudanese](Sudan "Sudanese"){.wikilink} border crossing near [Gonder](Gonder "Gonder"){.wikilink} to the [Kenyan](Kenya "Kenyan"){.wikilink} border at [Moyale](Moyale "Moyale"){.wikilink}. His experience was very positive, and even though little children and also adults were very curious whenever he passed through a village, he experienced none of the rock throwing mentioned in other reports. Waiting time was generally short.

</div>
</div>
<div class="hw-experience">

`<span class="hw-exp-author">`{=html}KiwiAoraki`</span>`{=html} `<span class="hw-exp-date">`{=html}February 2012`</span>`{=html}
...
Source: [Ethiopia](https://hitchwiki.org/en/Ethiopia)
