...
The **Netherlands** are a member state of the [European Union](European_Union "European Union"){.wikilink} as well as the [Schengen Agreement](Schengen_Agreement "Schengen Agreement"){.wikilink}.

## Hitchhiking

Asking the Dutch people at a service station is faster than waiting while using the thumb for hitchhiking.

Hitchhiking is fairly common in the Netherlands you can regularly spot people hitchhiking to travel, some also hitchhike as a freetime activity.

![There are many creeks in the Netherlands and they can make it hard to get to petrol stations on the motorway](Hitchhiking_across_the_creek.jpg "There are many creeks in the Netherlands and they can make it hard to get to petrol stations on the motorway"){width="250"} Since 1991 Dutch students have a card providing them with free public transport (either on weekends or during the week), so hitchhiking is not as popular as it used to be. In some university towns there are still [liftershaltes](liftershalte "liftershalte"){.wikilink}, which are [official hitchhiking](Official_Hitchhiking "official hitchhiking"){.wikilink} spots.

Other good places are petrol stations along the motorways and the entrances to the motorway from larger cities (when there is a stopping space such as an emergency lane). On such a place the usual waiting time is 5--45 minutes (same as Germany). A major difference with [Germany](Germany "Germany"){.wikilink} is that many lifts are not longer than 50 km.
...
Dutch law says nothing about hitchhiking, so it is legal wherever you may lawfully be on foot. [Article 42 of the *Reglement verkeersregels en verkeerstekens* (RVV 1990)](https://wetten.overheid.nl/BWBR0004825) permits use of an *autosnelweg* only to drivers of motor vehicles that may and can travel at least 60 km/h --- 50 km/h on an *autoweg* --- which keeps pedestrians off the carriageway, the hard shoulder and the slip road past the blue sign. The useful part is in the definitions: article 1 states that parking places, petrol stations and bus stops lying *alongside* a motorway are not part of it, so standing at a motorway *tankstation* or *verzorgingsplaats* and asking drivers is straightforwardly legal. Article 43 also forbids drivers to turn round or reverse on a motorway, so nobody can come back for you once they have passed. On every other road, stand where a pedestrian may stand --- off the carriageway, on the shoulder or the verge --- and thumb.

The basic idea is that when you\'re allowed to walk somewhere, you can stand there for hitching too. Standing on a motorway entrance just in front of the motorway sign is allowed as well as standing on a petrol station along the motorway.

## Useful tips {#useful_tips}

- Download and print [42 ready made hitchhiking signs](http://www.franknature.nl/hitchhike/hitchhike_cardboards_NL.pdf) for easy hitchhiking all across the Netherlands!
...
- The system to pay for public transport is called *OVpay*. You can check in with either an *OV-chipcard* wich you can buy at a ticketmachines, or a contactless debit or credit card, or a mobile phone linked to a contactless payment system. All expenses of one travel day are taken of your account on the next day. If you\'ve checked in but not checked out 20 euro will be taken out.
...
: Service station Kloosters (Shell), A59, Tilburg \--\> Eindhoven ([Fverhart](User:Fverhart "Fverhart"){.wikilink} was asked once out of 4 times), other hitch-hikers have also been asked not to talk with costumers **Winner of Most Unfriendly Petrol Station Award in the Netherlands**

: Service station Swentibold (Shell), A2, Maastricht \--\> Eindhoven ([Fverhart](User:Fverhart "Fverhart"){.wikilink} was asked once out of 6 times)

: Service station Haarrijn (Shell), A2, Amsterdam \--\> Utrecht ([Fverhart](User:Fverhart "Fverhart"){.wikilink} was asked once out of 7 times)

## Links

- [Facebook group Hitchhiking in Belgium and the Netherlands](https://www.facebook.com/groups/467054706678994/)
- [Hitchhiking in the Netherlands](http://www.franknature.nl/hitchhike/hitchhike.htm), by [Frank Verhart](User:Fverhart "Frank Verhart"){.wikilink}.
- [Nederland Lift](http://www.nederlandlift.nl/), campaign to promote hitchhiking as a daily means of transport.
- [Survey about hitchhiking in the Netherlands](Hitchhiking_in_the_Netherlands_Survey "Survey about hitchhiking in the Netherlands"){.wikilink}
