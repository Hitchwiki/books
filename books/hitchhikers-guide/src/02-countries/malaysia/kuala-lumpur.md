...
\
**Kuala Lumpur** is the capital of [Malaysia](Malaysia "Malaysia"){.wikilink}.
...
There is a system of (formerly free) buses known as GoKL ([1](http://www.gokl.com.my/)). These purple buses go to various malls and tourist attractions, but can successfully be used to traverse the majority of the city. Update 31.Jan 24: GOKL-busses are not free anymore, a contactless credit card is needed for touch n go. 1RM for the ticket.
