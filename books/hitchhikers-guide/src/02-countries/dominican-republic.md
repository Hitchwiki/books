...
The \'\'\'\'\'\' is the eastern part of the [Caribbean](Caribbean "Caribbean"){.wikilink} island of [Hispaniola](Hispaniola "Hispaniola"){.wikilink}, the western part of the island is [Haiti](Haiti "Haiti"){.wikilink}

## Hitchhiking

Hitchhiking in the Dominican Republic is - like in many countries in the [Caribbean](Caribbean "Caribbean"){.wikilink} - farely common.
...
The Dominican Republic is one of the few countries that penalises hitchhiking by name, and the wording of the offence is what matters. [Article 219 of Ley 63-17](https://dgii.gov.do/legislacion/leyesTributarias/Documents/Otras%20Leyes%20de%20Inter%C3%A9s/63-17.pdf) fines anyone who places themselves \"on the carriageway or running surface of a public road\" in order to obtain public transport, **to request transport**, to collect money, hand out leaflets or sell things --- one minimum wage of the central public sector. The offence is stepping onto the *calzada*, not asking: the *paseo* is defined separately in article 2 as the strip beside the carriageway used for parking, for movement in cases of urgent necessity and as lateral support, and article 219 does not reach it. So stand well off the running surface. Article 218 otherwise governs how pedestrians cross, requiring footbridges and marked crossings where they exist, and nothing in the Act closes a road class to pedestrians outright.

## Hitchhiking in DR means \"una bola\" {#hitchhiking_in_dr_means_una_bola}
...
## Why hitchhiking is part of the Dominican culture already {#why_hitchhiking_is_part_of_the_dominican_culture_already}
...
Check out a hitchhiker\'s personal experience [here on YouTube.](https://www.youtube.com/watch?v=FhcXDTZ2iJA&index=1&list=PLKvXdnK3gVW0p4OmRNlCnh2v14Xv4vIO_)
...
## Boats out of here {#boats_out_of_here}
...
## [Boat hitchhiking](Boat_hitchhiking "Boat hitchhiking"){.wikilink} {#boat_hitchhiking}
...
`<span class="hw-exp-author">`{=html}[Treefrog](User:Treefrog "Treefrog"){.wikilink}`</span>`{=html} `<span class="hw-exp-date">`{=html}19 January 2021`</span>`{=html}

<div class="hw-exp-text">

*I tried hitchiking in the northern DR twice during the coronavirus pandemic, and found it quite difficult. The first time, from Las Terrenas to Puerto Plata, no one ever stopped for me except guaguas, which I ended up taking instead after about 30 minutes to an hour waiting in each spot (though I had my pick of less-crowded ones, since another would come by about every 15 minutes). The second time, I was trying to get from the Santiago airport back to Las Terrenas. I understand people not wanting to let me inside their cars during the pandemic (I preferred not to do that either anyway), but I was disappointed at the large number of empty pickup trucks that passed without ever offering me a ride in the back. I did get three short rides from pickups or flatbed trucks, but it seemed like the only way to do it was to catch them when already stopped, and yell \"una bola?\" through their open window. I also got a couple short free rides from motorcycles. But my progress was painfully slow, and I ended up starting again the next day with guauguas. Maybe it was just because people are nervous during the pandemic, or maybe because my face was covered with a mask. Hope it will be better some other time! On the bright side, I didn\'t see any sign of it being dangerous at all.* [Treefrog](User:Treefrog "Treefrog"){.wikilink} ([talk](User_talk:Treefrog "talk"){.wikilink}) 04:41, 19 January 2021 (CET)Treefrog

</div>
</div>
<div class="hw-experience">

`<span class="hw-exp-author">`{=html}Carry_On_My_Wayward_Thumb`</span>`{=html} `<span class="hw-exp-date">`{=html}March/April 2026`</span>`{=html}

<div class="hw-exp-text">

We hitchhiked a lot during our trip to the DR, mostly in the mountainous area in the center of the country, and never had to wait more than five minutes for a ride. It was almost always the first car/truck that happened along would pick us up. People were friendly and helpful and always understood the concept of hitching- we were never asked for any money, and oftentimes folks would drive far out of their way to get us where we were going. It helps a lot to speak advanced Spanish- many rides we got were in the cars with the drivers, and Dominicans speak very fast (especially those who do not interact regularly with tourists). Several rides were caught in the beds of trucks with no problem either. One of us continued to travel in the southwest of the country with similar experiences, although cars are few and far between in some areas, and it might be a while before you see anyone who could feasibly pick you up. - Carry_On_My_Wayward_Thumb. March/April 2026.
