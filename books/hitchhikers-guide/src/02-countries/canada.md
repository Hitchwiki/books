...
Even if the country bears some similitude with its southern (and only) neighbour, the [United States](United_States_of_America "United States"){.wikilink}, the cultural and life outlook of the population is markedly unique.
...
It is worth noting that in Quebec, the carshare website \"AmigoExpress\" is extremely popular. Worth checking out if a bit pressed for time and have a bit of cash to spare. There are more than 50 rides a day between Quebec and Montreal at costs of 15-30 CAD.

## Hitchhiking

For the convenience of the common hitchhiker the provinces and territories are discussed in detail, along with their capitals, in separate pages.

For a journey across the country, the [Trans-Canada Highway](Trans-Canada_Highway "Trans-Canada Highway"){.wikilink} is the main road crossing the country east to west. However, the highway system numbering system is specific to every province.

## Legality of Hitchhiking {#legality_of_hitchhiking}

Canada has no federal offence of hitchhiking --- the Criminal Code says nothing about it and roads are a provincial matter, so the rule you are actually under is your province\'s. British Columbia is the most clearly drafted example: [section 182(3) of the Motor Vehicle Act](https://www.bclaws.gov.bc.ca/civix/document/id/complete/statreg/96318_05) provides that \"a person must not be on a roadway to solicit a ride, employment or business from an occupant of a vehicle\", and section 182(4) makes contravening the section an offence except where the ride was solicited in an emergency. The word doing the work is *roadway*: section 182(2) tells a pedestrian with no sidewalk to use \"the extreme left side of the roadway or the shoulder of the highway\", so the Act plainly treats the shoulder as something other than the roadway --- and thumbing from the shoulder is accordingly outside the prohibition. That same subsection also puts you on the left, facing the oncoming traffic, which is where a hitchhiker in British Columbia should expect to stand. Every province has its own version of this section, so read the wording of yours rather than assuming BC\'s, and expect any controlled-access highway to exclude pedestrians by its own posted signs whatever the provincial code says.

## [Winter](Winter "Winter"){.wikilink} hitchhiking {#winter_hitchhiking}
