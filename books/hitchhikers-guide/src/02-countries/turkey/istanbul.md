...
\
**Istanbul** is the biggest city of [Turkey](Turkey "Turkey"){.wikilink}, partly in [Europe](Europe "Europe"){.wikilink} and partly in [Asia](Asia "Asia"){.wikilink}.

#### Test option - Ispartakule Park Area North {#test_option___ispartakule_park_area_north}
...
#### Out of city option {#out_of_city_option}
...
#### Getting to suburbans of Istanbul {#getting_to_suburbans_of_istanbul}
...
#### Trains out of city {#trains_out_of_city}

For those who rather not try hitchhiking through the overgrown western suburbs of the city, a slightly more expensive but a lot easier way to follow this westbound route to Greece may be to take the morning train to [Muratlı](Muratlı "Muratlı"){.wikilink} from Sirkeci station in central Istanbul, and then hitch your way forward to Greece via [Tekirdağ](Tekirdağ "Tekirdağ"){.wikilink} from there. See [Muratlı](Muratlı "Muratlı"){.wikilink} article for full details.
...
Check the article on [Kapikule-Kapitan Andreevo border crossing](https://hitchwiki.org/en/Kapitan_Andreevo-Kap%C4%B1kule_border_crossing) if you\'re going towards Bulgaria as it can be difficult.

#### From Şekerpınar close to Gebze {#from_şekerpınar_close_to_gebze}
...
There is no rest stop but the lane of the enterance becomes a shoulder lane in like 50 meters.Move a bit away from the lane so the cars from that enterance can see you and thumb all the highway cars and you\'ll have a ride in no time. As the police in Turkey are completely ambivalent towards thumbing on the highway catching a ride is pretty easy as long as you don\'t mind super-fast cars flying by you.

#### From Bostancı Köprüsü (Bostancı Bridge) {#from_bostancı_köprüsü_bostancı_bridge}

From *Taksim* Square take bus 129T (*Taksim - Üst Bostancı* line), which, like the other transcontinental bus lines, requires two tickets (3.50 TL). Get off at the leaf-clover interchange called in Turkish *Bostancı Köprüsü* (literally Bostancı Bridge), close to its last stop. You can recognize the interchange by big signs saying *Bostancı* and *İçerenköy* (besides the usual *İzmit* and *Ankara* signs) there. Then, after getting off the bus, walk past the interchange until you see a safe shoulder down the road a couple hundred metres away. Start hitching there ready with a [sign](Signs "sign"){.wikilink} saying at least '[Gebze](Gebze "Gebze"){.wikilink}\'/\'[Izmit](Izmit "Izmit"){.wikilink}', it'll make you more visible

There is a petrol station exactly 9km before [Izmit](Izmit "Izmit"){.wikilink} where you can be dropped off. It is recognizable for its BP petrol station and Burger King restaurant. Trucks are regularly parked here and bound for all points in Turkey, while sometimes one can even find a lift all the way to neighbouring countries.

For Mediterranean cities such as [Antalya](Antalya "Antalya"){.wikilink}, you should also take this eastwards route till [Adapazari](Adapazari "Adapazari"){.wikilink}, then head south via motorway D650 from there.

#### The free walking option {#the_free_walking_option}
