...
`<span class="hw-exp-author">`{=html}[The-nomaddicts](The-nomaddicts "The-nomaddicts"){.wikilink}`</span>`{=html} `<span class="hw-exp-date">`{=html}February 2020`</span>`{=html}

<div class="hw-exp-text">

During February 2020, [The-nomaddicts](The-nomaddicts "The-nomaddicts"){.wikilink} were denied entry to the province of Labé due to security concerns. Guinea is a relatively unstable country so it is best to check with your embassy about any road closures. The rest of the country finding rides was pretty easy and they got rides on all manner of free transport, from company cars and trucks to taxis and pickups. Rides from trucks were especially frequent. Some roads get very little traffic and are in bad shape, such as the road from Gueckedou to Macenta, (between Gueckedou and Gozombou is completely unpaved as of 2020), but with patience you will eventually find a long-distance truck.
