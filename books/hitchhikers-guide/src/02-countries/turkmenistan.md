...
**Turkmenistan** (also **Turkmenia**) is a country in [Central Asia](Central_Asia "Central Asia"){.wikilink}.
...
`<span class="hw-exp-author">`{=html}[Apprentis-Vagabonds](User:Apprentis-Vagabonds "Apprentis-Vagabonds"){.wikilink}`</span>`{=html} `<span class="hw-exp-date">`{=html}September 2018`</span>`{=html}
