...
## Tips for women travelers {#tips_for_women_travelers}

Especially women have to take care of safety, read more [here](Tips_for_women_travelers "here"){.wikilink}.

## What could possibly go wrong? {#what_could_possibly_go_wrong}
...
This mainly affects solo traveling women, please read more [here](Tips_for_women_travelers "here"){.wikilink}.
...
In 2018 we thought it\'s good to start building a team of people working on this (see also <https://meta.trustroots.org/c/safety>). Since 2019, our support / safety team consists of two people. More volunteers are welcome. Especially having a female point of view would be great in this team! If you are interested, join the [volunteer chat](https://team.trustroots.org/Chat.html).
...
## More safety advices {#more_safety_advices}
