...
The concept of **Hospitality Exchange**, also known as "accommodation sharing", "hospitality services" (short "hospex"), and "home stay networks", refers to centrally organized [social networks](social_network "social network"){.wikilink} of individuals, generally travelers, who offer or seek accommodation without monetary exchange. Generally, these services connect users via the internet.

## History

In 1949, Bob Luitweiler founded the first hospitality service called [Servas Open Doors](Servas_Open_Doors "Servas Open Doors"){.wikilink} as a cross national, non-profit, volunteer run organization advocating interracial and international peace. In 1965, John Wilcock set up the Traveler\'s Directory as a listing of his friends willing to host each other when traveling. In 1988, Joy Lily rescued the organization from imminent shutdown, forming Hospitality Exchange. In 2000, Veit Kuhne founded [Hospitality Club](Hospitality_Club "Hospitality Club"){.wikilink}, the first widely known Internet-based service (many others existed since the late 90s but never reached the high number of users that HC reached). In 2004, Casey Fenton started [CouchSurfing](CouchSurfing "CouchSurfing"){.wikilink}, now the largest hospitality exchange organization.

## How they work {#how_they_work}

Generally, after registering, members have the option of providing very detailed information and pictures of themselves and of the sleeping accommodation being offered, if any. The more information provided by a member improves the chances that someone will find the member trustworthy enough to be their [host](host "host"){.wikilink} or guest. Names and addresses may be [verified](verification "verified"){.wikilink} by volunteers. Members looking for accommodation can search for [hosts](host "host"){.wikilink} using several parameters such as age, location, gender, and activity level. Home stays are entirely consensual between the [host](host "host"){.wikilink} and guest, and the duration, nature, and terms of the guest\'s stay are generally worked out in advance to the convenience of both parties. No monetary exchange takes place except under certain circumstances (e.g. the guest may compensate the host for food). After using the service, members can leave a noticeable reference about their host or guest.
...
### Monetary savings {#monetary_savings}
...
These systems foster richer and more convenient travel experiences not so much on the premise of [altruism](altruism "altruism"){.wikilink}, but on the basis of [social exchange theory](social_exchange_theory "social exchange theory"){.wikilink}. Implicit in the agreement to host travelers is the ability to ask to be hosted by them in the future. If one enjoys having interesting guests in their home, this works out well for both parties. It works comparatively better if you are visited by travelers from a locale you find particularly attractive. Thus, hosting someone from [New York City](New_York_City "New York City"){.wikilink} in [Gainesville, Florida](Gainesville,_Florida "Gainesville, Florida"){.wikilink} seems to be an unbelievable opportunity. Moreover, if you are a Westerner visiting someone in a [developing country](developing_country "developing country"){.wikilink}, your stay might be the only way that this individual or family could afford a trip to a rich nation. This may mean more than just a relaxing vacation for such disadvantaged parties.

### Ecological sustainability {#ecological_sustainability}
...
### Lack of guarantee {#lack_of_guarantee}
...
### Potential interpersonal conflict or awkwardness {#potential_interpersonal_conflict_or_awkwardness}
...
### Digital divide and demographic segregation {#digital_divide_and_demographic_segregation}
...
## Example networks {#example_networks}
...
- [CouchSurfing](CouchSurfing "CouchSurfing"){.wikilink} - A very active network with over 14 million members in more than 200 countries
- [BeWelcome](BeWelcome "BeWelcome"){.wikilink} - An active network with over 115.000 members in more than 200 countries
- [Trustroots](Trustroots "Trustroots"){.wikilink} - An active network with over 34.000 members
- [Hospitality Club](Hospitality_Club "Hospitality Club"){.wikilink} - An out-dated network with over 790.000 members, but most of them not active any more
- [Servas International](Servas_Open_Doors "Servas International"){.wikilink} - Human rights and global peace oriented since 1949. A relatively small network now with over 15.000 members(?) with a very long history

### Specialized networks {#specialized_networks}
...
- Homeshare International [7](http://www.homeshare.org/) - charity organisation providing exchange of housing for help in the home.
- Ridester[8](http://www.ridester.com) \-- ride sharing for travelers.
