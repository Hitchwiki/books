...
Unfortunately there seem to be some people who are trying to abuse the system. First of all: If you suspect someone is trying to freeload, feel free to say \"No!\" But, \"the only way to solve problems is to first voice them.\" (Kate L.) Try to find out the reasons for a special way of behavior and decide case by case **how to handle freeloaders** on [CouchSurfing](CouchSurfing "CouchSurfing"){.wikilink}.

## What is a freeloader? {#what_is_a_freeloader}

[Freeloaders](Freeloader "Freeloader"){.wikilink} are people who only use CouchSurfing as a way to stay for free at someone\'s house. These kind of people do not care that much about the people hosting them. The most important thing to them is saving money, rather then to respect were the couchsurf community stands for.
...
Then there are **COUCHSCROOGERS** ( See [How to handle Couchscroogers](How_to_handle_Couchscroogers "How to handle Couchscroogers"){.wikilink}
...
## Warnings in the profile {#warnings_in_the_profile}
...
## Moneyless doesn\'t mean freeloading {#moneyless_doesnt_mean_freeloading}

There are quite a few people who live completely without money, or with very little. They are not necessarily freeloaders. A lot of people \"give back\" in other ways such as bringing in food through [dumpster diving](dumpster_diving "dumpster diving"){.wikilink}, helping out with tasks or fixing your computer. It\'s good to be considerate of moneyless people. They shouldn\'t be confused with freeloaders, also, most moneyless people manage to survive because they are nice and do NOT behave like freeloaders. There\'s a whole website about living this way: [Moneyless.org](https://moneyless.org/)
