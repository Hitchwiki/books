...
Basically a **tarp** is a sheet of plastic, which is tossed over a ridgeline, tied between two trees, walking sticks, or whatever you can find. Unlike the static [tents](camping "tents"){.wikilink} and [bivys](http://nomadwiki.org/en/Bivouac_sack), tarps are very flexible. Besides the multiple designs, you can decide, whether you want to use a groundsheet or carry a mosquito net.
...
## Websites about tarp camping {#websites_about_tarp_camping}

- [Tarpin\' it](http://www.digihitch.com/ftopict-3905.html), Thread on Digihitch.com (Registration needed)
