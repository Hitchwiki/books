...
Some people chose to have a [trailer](https://en.wikipedia.org/wiki/Bicycle_trailer) to carry more stuff. The friction created by the added wheels makes it much harder, especially going up. A combination with an electric bike (and a solar pannel?) can be a good choice.

Always have a [good lock](https://en.wikipedia.org/wiki/Bicycle_lock#U-locks_and_D-locks) for your bike (U-locks are the best), especially if it is a good bicycle. The best would be to put inside a house anytime you can. As well, think of a system to take all your stuff easily with you, otherwise you will have to leave them on your bike if you are too lazy to spend 15min freeing your baggages every time you stop.
...
Keep in mind that \'national roads\' (like the ones we have in [Europe](Europe "Europe"){.wikilink}) are enjoyable compared to highways if you have a car, but are often horrible by bike\... It is really stressful to have big trucks overtaking all the time, the noise of the cars, you cannot talk with your buddy. Plan your trip so that you avoid them as much as you can. It can be really worth making a 10km detour but enjoying the view and the peacefulness of a less frequented secondary road.
...
[What other things should I pack?](What_to_pack "What other things should I pack?"){.wikilink}

## History

In 1886, [Thomas Stevens](http://en.wikipedia.org/wiki/Thomas_Stevens_%28cyclist%29) became the first man to cycle round the world. His two-year jaunt on a penny-farthing saw him tackle roads more suited for ox-drawn carts than bicycles.

## Types of bike {#types_of_bike}

[Racing bike](https://en.wikipedia.org/wiki/Racing_bicycle), [mountain bike](https://en.wikipedia.org/wiki/Mountain_bike), [electric bike](https://en.wikipedia.org/wiki/Electric_bicycle), [recumbent bicycle](https://en.wikipedia.org/wiki/Recumbent_bicycle), [tandems](https://en.wikipedia.org/wiki/Tandem_bicycle), old pieces of metal gathered from random basements, all give advantages and impose restrictions.
...
- [globalbiker.org](http://globalbiker.org/) have biking routes, only in France for now (feb 2015).
- [opencyclemap.org](http://www.opencyclemap.org/) is good map for finding your route.
