...
[img\_assist|nid=2659|title=|desc=|link=none|align=right|width=325] We've had quite some cyclist passing through the house. Cycling around the world, or just the Netherlands, or people cycling from Paris to Copenhagen for example. Most of these people found out about the house through friends or through hospitality exchange networks such as [Couchsurfing](http://couchsurfing.com) (closed-source and top-down structured) or [Bewelcome](http://bewelcome.org) (which is more grassroots and based on open source/ free software). But so far none of the cyclist had contacted us through [Warmshowers.org](http://warmshowers.org), a hospitality exchange network for touring cyclists. 
Up until last week when [Lionel](http://www.alaconqueteducap.canalblog.com/) contacted us through that network. He travels by bike from a town South of France towards the [North Cape](http://en.wikipedia.org/wiki/North_Cape,_Norway), and back, for which he calculates 7 months to do. An interesting point is that Lionel managed to get funding from his local council to make this trip, which also made his step to quit his water research-job more easily.
...
Lionel also holds a blog in French. Here an excerpt from his [latest post](http://alaconqueteducap.canalblog.com/archives/pays_bas/index.html), where he is also mentioning the Casa.
...
<p class="chapter-source"><a href="https://casarobino.org/node/2660">node/2660</a></p>
