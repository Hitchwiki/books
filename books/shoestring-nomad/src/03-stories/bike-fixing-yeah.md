...
- Miss Brown II (aka Sadam)
- Superbe
- Mirtilla
- Rene/Laura bike (needs a new name:aka Black Bitch)
- Victor (finally the chain is working
- Mama (gears are working)
- Anarcho (Anu, you want it back?)
- Isolator
- Junkie (finally!)
- Gypsy
- Wobalina
- My Bike
- Miss Brown I (1/2) (you can ride her but only with one pedal)
There are only two more bikes that need to be fixed, Racing and Golden bike (which is parked in Weesp, in front of the library). And the Germ is also Missing in Action at the moment.
