...
To see the user map, you have to be logged in and click on "User locations" on the menu bar at the very top of the page, or alternatively, click here http://casarobino.org/map/user
And in this way, we`ll always know where kitten is ;)
thumbs up!

---

<p class="chapter-source"><a href="https://casarobino.org/node/17634">node/17634</a></p>
