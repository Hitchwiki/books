...
Things done so far include brainstorming about legal stuff for [nomadbase](http://sharewiki.org/en/Category:Nomadbase) (social contract for example) and ad-hoc brainstorming and also an action plan for [lightfoot]( http://nomadbase.org/2009/11/23/lightfoot-sweep-berlin).
We also have been doing stuff on the website [nomadbase.org](http://nomadbase.org) and will go live very soon with a new theme. And we're looking forward to hack more on this with design people!. Owen? Amylin?
...
Check for the latest http://nomadbase.org & change your theme in the account settings if you haven't done that yet.

---

<p class="chapter-source"><a href="https://casarobino.org/node/8110">node/8110</a></p>
