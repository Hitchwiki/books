...
At this moment [Mark](/users/pixelwhip) is working on a pre-release for Random Roads of 16 pages that we hope to offer to you very soon. With that pre-release we will also be better able to get the funds together to print the first issue (more about this later).
