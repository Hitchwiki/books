...
De Zuid-Koreaanse variant is om de techbedrijven die gebruik maken van robots en andere geautomatiseerde fabrieken te laten betalen voor het basisinkomen. Tegelijkertijd kunnen mensen die het basisinkomen ontvangen, dit geld alleen lokaal of regionaal spenderen. Zie bijvoorbeeld dit [videoverslag](https://www.youtube.com/watch?v=EbWv\_1NbWyw) over basisinkomen in Zuid Korea. Dit werkt een beetje zoals het concept van [sociaal of lokaal geld](/sociaal-geld), alleen dan met een betaalkaart die bijvoorbeeld alleen bij de aaneengesloten winkels en dienstverleners besteed kan worden.
De Franse econoom en filosoof [André Gorz](https://fr.wikipedia.org/wiki/Andr%C3%A9_Gorz) stelt:
...
* Rijke mensen kunnen een groot deel van hun [geld sparen](https://rijkwordenmetbeleggen.nl/spaarrekeningen-vergelijken) in plaats van uitgeven. Dit is deels oké omdat het mogelijk maakt om kapitaal op zij te zetten voor grotere investeringen, maar het netto resultaat is vandaag dat geld uit circulatie verdwijnt in de richting van belastingparadijzen. Arme mensen geven het meeste of zelfs al hun geld uit. En [de maatschappij moet meer geld uitgeven](http://www.pieria.co.uk/articles/basic_income_and_the_atavistic_appeal_of_austerity), niet minder, om de economie opnieuw draaiend te krijgen. Een basisinkomen schaadt de rijken niet, omdat het meeste uitgegeven geld toch weer belandt bij mensen die gespaard of geïnvesteerd hebben.
  
* Een basisinkomen kan de hele bureaucratie rondom de huidige sociale zekerheid vervangen. Het is niet meer nodig om "bijstandstrekkers" aan het werk te krijgen of fraudeurs op te sporen. Tegelijkertijd kan het belastingsysteem grotendeels worden vereenvoudigd. In veel landen is de belastingdienst het grootste overheidsorgaan. Zelfs [Lean Government](http://en.wikipedia.org/wiki/Lean_Government) mensen en de Amerikanen die achter de Tea Party staan kunnen geen nee zeggen tegen dit idee.
...
* [basisinkomenvoordummies.nl](http://www.basisinkomenvoordummies.nl/)
* [Wikipedia](https://nl.wikipedia.org/wiki/Basisinkomen)

### Politieke partijen en het basisinkomen

* http://basisinkomen.net/obi/politieke-partijen-met-basisinkomen-het-programma/
* http://basisinkomen.nl/welke-politieke-partijen-hebben-een-basisinkomen-in-het-partijprogramma/

### In het Engels

* [BIEN: basicincome.org](http://www.basicincome.org/)
* [Reddit: Basic income](https://www.reddit.com/r/BasicIncome/)
