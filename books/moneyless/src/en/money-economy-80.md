...
> Money is impersonal and reduces qualitative values to a quantity ([source](http://en.wikiquote.org/wiki/Money))

## Other economies

Other economic forms or concepts are for example:
- [Gift economy](/gift-economy)
- [Swap economy](/bartering)
- Sharing economy
...
Through the dominance of borrowing money there's also the process of commodifying. It means that the value of everything is expressed in money. Even of stuff that was previously freely shared, such as [food](/no-money-food). There's a price attached.
We think it's good, because it ensures a certain distribution. But it's a system based on the creation of scarcity and it's thriving on poverty, overproduction and for example [food waste](/dumpster-diving-tips). All in all we don't even know what the value of money is.
