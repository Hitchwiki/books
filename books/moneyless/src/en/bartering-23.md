...
## Examples of online bartering {.aside}
- Thanks to the internet, many apps and websites have been developed to make bartering easy.
- To get started, download apps like [Vinted](https://www.vinted.com/) [Trashnothing](https://trashnothing.com/), [Listia](https://www.listia.com/), [Peerby](https://www.peerby.com/), [The Gone App](http://thegoneapp.com/) and many others.
- For trading games, try [GameTZ](http://gametz.com/). [For books, try PaperBackSwap](http://www.paperbackswap.com/index.php). For CDs, try [SwapaCD](http://www.swapacd.com/). For DVDs, try [SwapADVD](http://www.swapadvd.com/).
...
## Basics of Bartering {.aside}
\* \*\*Bartering in the US or Europe.\*\* "Can you fix my computer? Then I'll fix your curtains." In many countries there are examples of functional networks for bartering and local exchange, such as [Noppes](https://www.noppes.nl/) in Amsterdam, where many people participate. Often these barter networks work with a certain credit or point system. You get an amount of credit if you have offered a service successfully. This credit you can use to request other services. This is also called a \_[LETS system](https://en.wikipedia.org/wiki/Local\_exchange\_trading\_system)\_. These exchange system consist of a group of people that barter with each other based on points.
...
\* \*\*Free stuff thanks to bartering.\*\*Bartering can also be a fantastic way to get [free stuff](/free-stuff). This is easiest if you have stuff yourself that you want to give away. Inform people in your area which stuff you want to exchange and what you would like to get in return.
\* \*\*Bartering to live without money.\*\* Many people who live without money decide to use bartering. The German [Heidemarie Schwermer](/heidemarie-schwermer-rich-life-without-money) even created a an entire network: *Gib und Nimm* (give and take).
...
\* \*\*Society based on bartering.\*\* A society based on bartering might be hard to imagine. But it could work in combination with the [gift economy](/gift-economy) and the sharing economy. You can think of a way where people share their means of existence such as food, cars and housing. Everyone who has access to this sharing circle, for example by adding something themselves, gets the right to use all of it. You could extend it with services and shared insurance. This is already happening in a small scale, for example in the [Twin Oaks intentional community](/living-without-money-twin-oaks/), where 100 people are sharing.
...
\* \*\*For business.\*\* Try [BizX](https://www.bizx.com/) which according to their website their purpose is "to improve the lives and businesses of our members. At our core is a deep passion for local business, and a personal understanding of the experience of the business owner."
...
![How to get free bitcoins](https://moneyless.org/sites/moneyless.org/files/bartering\_websites.png){.img-above-ul}
## Get started bartering: BARTERING WEB SITES {.background}
...
\* Apps like [Trademade](https://itunes.apple.com/us/app/trademade-a-trade-and-barter-app-with-a-cause/id1111198297?mt=8) and [letgo](https://itunes.apple.com/us/app/letgo-buy-sell-second-hand-stuff/id986339882?mt=8) are great.
\* Currently existing websites that will help you with Bartering, like pages on [Facebook's marketplace](https://www.facebook.com/marketplace), [Noppes](https://www.noppes.nl/), [Bliive](https://bliive.com/), [TradeAway](http://www.tradeaway.com/), various Craigslist barter pages, [Ebay](http://stores.ebay.com/sell-barter-trade), ZipCar, [Freecycle](https://www.freecycle.org/) etc.
...
[[nid:236]]
![Bartering](https://moneyless.org/sites/moneyless.org/files/bartering\_the\_rich\_giving\_away\_free\_stuff.png){.img-above-ul}
## Get started bartering: FREE STUFF FROM RICH PEOPLE {.background}
...
\* You can [borrow money from friends](https://moneyless.org/borrowing-money-friends) if you are in a financial quagmire of some kind.
\* Rich people give away free stuff all over, including living stuff on the street and [asking for little money for expensive things sold at yard sales](https://moneyless.org/free-stuff).
\* Sometimes you can get stuff that [rich people sold at pawnshops](https://moneyless.org/online-pawn-shops) at reasonably low prices and resell it online.
![bartering](https://moneyless.org/sites/moneyless.org/files/bartering\_dumpster\_diving.png){.img-above-ul}
## Get started bartering: GO DUMPSTER DIVING {.background}
...
\* Go dumpster diving by [following tips here](https://moneyless.org/dumpster-diving-tips).
\* Try finding ways of getting 1000 free dollars in [various alternative ways](https://moneyless.org/i-need-1000-dollars-now-free).
\* You don't have to only go dumpster diving: here are other ways to get [1000 dollars now free](https://moneyless.org/i-need-money-now).
## Read more {.aside}
- [Mixed fortunes as solidarity economy takes root in Greece](https://www.theguardian.com/world/2015/jul/17/solidarity-economy-greece-mixed-fortunes)
[[nid:237]]
