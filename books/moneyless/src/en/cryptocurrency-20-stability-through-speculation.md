# Cryptocurrency 2.0: stability through speculation
...
It's probably good to mention here that there are many more cryptocurrencies beside Bitcoin. One of these so-called altcoins is the Protoshare (PTS), started by [Invictus Innovation](http://invictus-innovations.com/). Invictus want to do more than just currencies, but also for example set up an encrypted, secure messaging system. Another idea is to set up a *decentralized exchange* through free software and decentralized agents, to decrease the dependency on one or more specific exchanges such as [Bitstamp](http://coinwiki.info/en/Bitstamp) and MtGox - and consequently also decrease the possibility for governments (e.g. [China](http://coinwiki.info/en/China) comes to mind) and banks to thwart the exchange of cryptocurrencies.
...
*More than two years later it seems that stability is not there yet (see e.g. [what happened](http://hackingdistributed.com/2016/06/18/analysis-of-the-dao-exploit/) with TheDAO). Meanwhile I've started a business around international payments and with that we're still far from using a blockchain for transactions.*
