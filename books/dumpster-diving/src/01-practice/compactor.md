...
![A compactor in [Ohio](Ohio "Ohio"){.wikilink}.](Compactor.jpg "A compactor in Ohio."){width="400"} A **compactor** (or **trash compactor**) is a mechanism used to reduce the size of [waste](waste "waste"){.wikilink} material through compaction. Many [supermarkets](supermarket "supermarket"){.wikilink} unfortunately use compactors for cycled produce and other waste. Often it is more difficult to collect [food](food "food"){.wikilink} from compactors through [dumpster diving](dumpster_diving "dumpster diving"){.wikilink} practice.
