...
The alternatives to inevitable consumption is a practice of [dumpster diving](dumpster_diving "dumpster diving"){.wikilink} (finding what is discarded) and reuse (fixing broken [stuff](stuff "stuff"){.wikilink}).

## Media on planned obsolescence {#media_on_planned_obsolescence}

### *The light bulb conspiracy* {#the_light_bulb_conspiracy}
...
- \<videoflash\>6HnW6Mm5sUI\</videoflash\>
...
### Radio programmes {#radio_programmes}
