...
![Dumpster diving finds in Austria.](Containernin_oesterreich.jpg "Dumpster diving finds in Austria."){width="350"} **Austria** is a country in Central [Europe](Europe "Europe"){.wikilink}.

## Cities and towns {#cities_and_towns}

- [Graz](Graz "Graz"){.wikilink}
- [Linz](Linz "Linz"){.wikilink}
- [Salzburg](Salzburg "Salzburg"){.wikilink}
- [Vienna](Vienna "Vienna"){.wikilink}
- [Spittal](Spittal "Spittal"){.wikilink} an der Drau
- `<small>`{=html}*add more?*`</small>`{=html}

## Dumpster diving {#dumpster_diving}

Although no longer uncommon in Vienna, [dumpster diving](dumpster_diving "dumpster diving"){.wikilink} is not a well known activity in rural Austria. Most waste in the country (even separated recycleables) is burned in (high-tech) facilities to produce heat and power. For this reason [trash](trash "trash"){.wikilink} is not as big of an issue as is in many other countries.

In March 2009, there was an instance of poison being poured on to the [food](food "food"){.wikilink} in the [dumpster](dumpster "dumpster"){.wikilink} that belongs to a [Hofer](Aldi "Hofer"){.wikilink} store in southern Vienna. Since some time the trash of almost all Hofer stores is effectively locked in outdoor cages.
...
Short films about freegans and dumpster diving in Austria: \<videoflash\>PWROOeLg8FY\|300\|250\</videoflash\>

\<videoflash\>EMeDnALEk0M\|300\|250\</videoflash\>

\<videoflash\>MqhKci8Yb5w\|300\|250\</videoflash\>

\<videoflash\>KYQkFTONtKk\|300\|250\</videoflash\>

\<videoflash\>qr0hoOQe2ak\|300\|250\</videoflash\>

\<videoflash\>C7eZCkqccbA\|300\|250\</videoflash\>

## Good links {#good_links}

- [freegan.at](http://www.freegan.at/)
